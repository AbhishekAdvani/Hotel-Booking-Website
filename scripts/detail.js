...
function login() {
  ...
  if (
    document.querySelector("#headerLoginBtn").innerText === "LOGIN" &&
...
function printRating(rating) {
  ...
  if (rating.length > 1 && rating[2] != "0") {
    ...
    ratingString =
      ratingString +
      `<i style="color: orange" class="fa-solid fa-star-half-stroke rating"></i>`;
...
function calculateprice() {
  document
    ...
    .setAttribute("min", document.querySelector("#checkInDate").value);
